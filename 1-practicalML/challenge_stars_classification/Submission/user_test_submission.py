...
vf_train_filename = '../data/public/train_varlength_features.csv.gz'
...
if __name__ == '__main__':
    ...
    skf = StratifiedShuffleSplit(
        y_array, n_iter=2, test_size=0.5, random_state=57)
    print("Training file ...")
    for valid_train_is, valid_test_is in skf:
        ...
        y_valid_pred = clf.predict(X_valid_test_array)
        y_valid_proba = clf.predict_proba(X_valid_test_array)
