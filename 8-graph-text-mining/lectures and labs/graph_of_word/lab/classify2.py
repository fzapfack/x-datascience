...
#On va determiner le best parametre pour le choix de feneter
...
for sw,sliding_window in enumerate(range(2,10,2)):
	auc=np.zeros(len(range(2,10,2)),1)
	...
	auc[sw]=metrics.auc(precision, recall)
