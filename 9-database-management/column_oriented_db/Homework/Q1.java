...
public class Q1 {
	...
	public static class topk_Mapper extends Mapper<Object, Text, IntWritable, IntWritable> {
		private IntWritable author = new IntWritable();
	...
	public static class topk_Reducer extends Reducer <IntWritable, IntWritable, IntWritable, IntWritable> {
		private IntWritable author = new IntWritable();
		private IntWritable n_coauth = new IntWritable();
		private TreeMap<Integer,Integer> tm = new TreeMap<Integer,Integer>(new Comparator<Integer>(){
                        @Override
